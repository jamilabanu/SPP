...
DATEDIFF(year, s.DateOfBirth, f.d.value('(Date/text())[1]', 'datetime')) as Age
into #ConsentForEval
...
--select e.StudentId, InitialConsentForEvaluation2, e.GivePermission, e.ECIReferral, ParentSignatureDate,Age
----, e.*
...
--SPP 11--
--select e.StudentId, c.InitialConsentForEvaluation, e.GivePermission, e.ECIReferral, ParentSignatureDate,Age
----, e.*
--from #Compliances_ConsentForEval e
--left join Compliances c on c.Student_Uid = e.Student_Uid
--where GivePermission = 'Yes'
--and (ECIReferral in ( 'No', '') or Age>=3)
--and RowNumber = 1
...
from #Compliances_ConsentForEval e
left join Compliances c on c.Student_Uid = e.Student_Uid
where (ECIReferral in ( 'No', '') or Age>=3)
and GivePermission = 'Yes'
and RowNumber = 1
and c.InitialConsentForEvaluation != ParentSignatureDate
...
(523978 rows affected)

(211101 rows affected)
...
Completion time: 2023-06-22T10:20:38.0301714-05:00
 */